...
<?php wp_nonce_field( 'update-options' ); ?>
    ...
    <table class="form-table">
        ...
        <tr valign="top">
        <th scope="row">Custom API End Point</th>
        <td><input type="text" size="50" name="airbrake_wordpress_setting_apiendpoint" value="<?php echo get_option( 'airbrake_wordpress_setting_apiendpoint' ); ?>" /></td>
        </tr>
    </table>
